...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-06-2021 a las 19:29:44
...
--
-- Base de datos: `s_facturacion`
--
CREATE DATABASE IF NOT EXISTS `s_facturacion` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `s_facturacion`;
...
(1, 'Lisset Vianey', '73203957', 'josealvaro21@hotmail.com', 'Cimas de San Bartolo 2, Pasaje 11 Grupo 11 Casa 27. Tonacatepeque', 1, '2021-06-05 05:51:43');
...
(1, 1, '2021-06-05 06:54:10', 1, 1, '1', '678', 1),
(2, 2, '2021-06-05 08:10:52', 1, 1, '1', '791', 1);
...
(1, '1', 'Coca Cola', 1, '2021-06-05 05:52:07', 100),
(2, '2', 'Pepsi', 1, '2021-06-05 05:52:20', 100);
